...
public interface ModuleService {
	 ...
	 * @return
	 */
	JSONObject findModule(Long id, String storeCode);
	...
	JSONObject findModule(String moduleId,String storeCode, String copyCode);
	
	public Long moduleCopy(Module module,Long pageId);


	void updateModuleByTabId(Long moduleId, Integer couponCenterTabId);
}
