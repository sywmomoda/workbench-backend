...
@Service
public class GwmsModuleServiceImpl implements GwmsModuleService{
	...
	@Autowired
	private GwmsPageServiceImpl pageService;
	...
	public String addModule(Map<String, Object> param) {
        ...
        module.setStoreScope(storeCode);
	...
	public void updateModule(Module module) {
        ...
        if (modulePersist != null) {
	        ...
	        modulePersist.setUpdateId(module.getUpdateId());
	        modulePersist.setUpdateTime(new Date());
	        moduleDao.updateModule(modulePersist);
        }
        logTraceService.sendLogger(module.getUpdateId(), module.getUpdateId(), "", "更新模块Id:"+modulePersist.getId()+",属性："+modulePersist.getModuleProperties(), "page", modulePersist.getPageId());
	}
